...
import { getSecurityModules, executeSecurityModule, SecurityModule, sanitizeInput } from './security';
      ...
      <LoginPage
        onLoginSuccess={(profile, token) => {
          if (token) {
            ...
            localStorage.setItem('fintrust_custom_token', sanitizedToken);
            setAuthToken(sanitizedToken);
            fetchUserData(sanitizedToken);
          }
